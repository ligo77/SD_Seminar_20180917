            ...
            begin
                if "Room Code" = '' then begin
                    ...
                    if(CurrFieldNo <> 0) then begin
                        if(SeminarRoom."CDS Maximum Participants" <> 0) and
                           (SeminarRoom."CDS Maximum Participants" < "Maximum Participants")
                        then begin
                            if Confirm(Text004, true,
                               "Maximum Participants",
                               SeminarRoom."CDS Maximum Participants",
                               FieldCaption("Maximum Participants"),
                               "Maximum Participants",
                               SeminarRoom."CDS Maximum Participants")
                          then
                                "Maximum Participants" := SeminarRoom."CDS Maximum Participants";
                        end;
                    end;
                end;
            end;
